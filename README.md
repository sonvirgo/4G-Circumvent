...
```Cảnh báo lừa đảo fake sacn trên mạng xã hội, Otofun.net, Voz.vn, GocMod.com, Openwrt Việt nam Facebook, Nhóm Psiphon Zalo,..v.v. Xem ở đây, do dối tượng người nước ngoài aztecrabbit cầm đầu, ``` [aztecrabbit's bugscanner issues#16](https://github.com/aztecrabbit/bugscanner/issues/16)
