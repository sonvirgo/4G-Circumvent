# MEEK CLIENT MULTI-SNI MULTI-SCAN MULTI-DEVICE CROSS-PLATFORM 
...
1 app duy nhất WYSIWYG. Viettel 0đ 0 nền. Tốc độ giới hạn 2Mbps -> 150k / 1 SIM.  Ko limit dung lượng. Đến khi hỏng SIM. (Bạn đã hiểu và đồng ý cam kết Mutual Agreement khi sử dụng app của chúng tôi. Chúng tôi luôn hỗ trợ     bài bản  bền bỉ tối đa, sản phẩm, dịch vụ chuyên nghiệp, độc đáo, có 1-0-2, trong khả năng có thể. Chúng tôi không cam kết các chính sách của nhà mạng. Chúng tôi không cam kết dịch vụ máy chủ VPS V2RAY)

1 app duy nhất WYSIWYG. Viettel 0đ 0 nền. Tốc độ giới hạn 54Mbps -> 550k /1 SIM. Ko limit dung lượng. Đến khi hỏng SIM. 54mbps (IDM aka Internet Download Manager), 10Mbps (Visual Studio Isntaller), 5Mbps (Play Store), 3Mbps (Edge download).... (Bạn đã hiểu và đồng ý cam kết Mutual Agreement khi sử dụng app của chúng tôi. Chúng tôi luôn hỗ trợ  bài bản    bền bỉ tối đa, sản phẩm, dịch vụ chuyên nghiệp, độc đáo, có 1-0-2, trong khả năng có thể. Chúng tôi không cam kết các chính sách của nhà mạng. Chúng tôi không cam kết dịch vụ máy chủ VPS V2RAY)
...
Công nghệ sử dụng  MEEK Client Server,  thông qua MEEK Network 2 &  3 infrastructure ,  ko phải V2Ray, SSH, Psiphon 


```Cảnh báo lừa đảo, kể từ tháng 10/2023 trên mạng xã hội, Otofun.net, Voz.vn, GocMod.com, Openwrt Việt nam Facebook, Nhóm Psiphon Zalo,..v.v. Do thằng ranh vặt người nước ngoài aztecrabbit, và thằng ranh vặt thuanht567 cầm đầu (đã bị cơ quan an ninh FSB đưa vào danh sách đen), xem ở đây:``` [on Dec 12, 2022 aztecrabbit's bugscanner issues#16](https://github.com/aztecrabbit/bugscanner/issues/16)
``` ```
...
Termux + thằng ranh vặt aztecrabit's Brainfuck Psiphon Pro Go ko thể chạy trên iOS và iPhone :D \
\
Cảnh báo 1 số thằng ranh vặt mod voz.vn lừa đảo, Server Psiphon đến thời điểm 8/2024, ko thể có 1 Server Psiphon aka  MEEK Server nào ở Việt nam 
```
Kể từ tháng 10/2023
1 số thằng ranh vặt dùng Termux, HC, INPV ăn cắp duy nhất 01 SNI IP xxx.x3x.xxx.x7x
Sẽ bị khóa
...
\
thằng ranh vặt mod voz.vn lừa đảo, ko thể có máy chủ Server Psiphon aka MEEK Server đặt tại Việtnam. CDN của Viettel ko đặt tại VN. Domain fronting ko kết nối Server Psiphon tại VN.
```
Căn cứ vào code snippets 
Termux ko phân chia đa luồng, do ứng dụng tự đảm nhiệm
BrainFuck Psiphon Pro Go của thằng ranh vặt aztecrabbit
