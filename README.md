...
1 app duy nhất WYSIWYG. Viettel 0đ 0 nền. Tốc độ 2Mbps -> 150k / 1 SIM.  Ko limit dung lượng. Đến khi hỏng SIM. (Bạn đã đồng ý cam kết Mutaul Agreement khi sử dụng app của chúng tôi. Chúng tôi không cam kết các chính sách của nhà mạng)

1 app duy nhất WYSIWYG. Viettel 0đ 0 nền. Tốc độ 54Mbps (IDM), 10Mbps (Visual Studio Isntaller), 5Mbps (Play Store), 3Mbps (Edge download).... -> 550k /1 SIM. Ko limit dung lượng. Đến khi hỏng SIM. (Bạn đã đồng ý cam kết Mutaul Agreement khi sử dụng app của chúng tôi. Chúng tôi không cam kết các chính sách của nhà mạng)
